...
// It's recommended to store these in a separate, non-public file in a real application
$db_host = "127.0.0.1";
$db_port = 3306;
$db_user = "root";
$db_pass = "";
...
if ($conn->connect_error) {
    ...
    error_log("Database Connection Failed (Register Script): " . $conn->connect_error);
    echo json_encode(['status' => 'error', 'message' => 'Database connection error. Cannot register at this time.']);
    exit;
}
