...
async function loadDiscounts() {
    try {
        showLoading();
        const response = await fetch('/Database_Project/src/api/get_discounts.php');
...
async function toggleDiscountStatus(id) {
    ...
    try {
        ...
        const response = await fetch('/Database_Project/src/api/toggle_discount_status.php', {
            method: 'POST',
            body: formData
        });
...
async function confirmDelete() {
    ...
    try {
        ...
        const response = await fetch('/Database_Project/src/api/delete_discount.php', {
            method: 'POST',
            body: formData
        });
