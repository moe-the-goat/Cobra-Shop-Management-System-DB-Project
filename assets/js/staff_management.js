...
class StaffManagement {
    ...
    async loadStaff() {
        try {
            ...
            const response = await fetch('/Database_Project/src/api/get_staff.php');
    ...
    async loadStaffOrders(staffId) {
        try {
            const response = await fetch(`/Database_Project/src/api/get_staff_orders.php?staff_id=${staffId}`);
            const data = await response.json();
    ...
    async updateOrderStatus() {
        ...
        try {
            ...
            const response = await fetch('/Database_Project/src/api/update_order_status.php', {
                method: 'POST',
                headers: {
    ...
    showToast(message, type = 'success') {
        ...
        // Fallback to custom toast container
